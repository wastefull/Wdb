...
export const MATERIAL_DOODLES: Record<string, MaterialDoodleManifestEntry> = {
  ...
  "Aerosol-cans": { imageFile: "image3.png", alt: "Aerosol-cans" },
  "alkaline-batteries": { imageFile: "image4.png", alt: "alkaline-batteries" },
  aluminum: { imageFile: "image5.png", alt: "aluminum" },
  "aluminum-can": { imageFile: "image6.png", alt: "aluminum-can" },
  "aluminum-foil": { imageFile: "image7.png", alt: "aluminum-foil" },
  americium: { imageFile: "image8.png", alt: "americium" },
  antimony: { imageFile: "image9.png", alt: "antimony" },
  argon: { imageFile: "image10.png", alt: "argon" },
  arsenic: { imageFile: "image11.png", alt: "arsenic" },
  "asphalt-shingle": { imageFile: "image12.png", alt: "asphalt-shingle" },
  astatine: { imageFile: "image13.png", alt: "astatine" },
  barium: { imageFile: "image14.png", alt: "barium" },
  beads: { imageFile: "image15.png", alt: "beads" },
  berkelium: { imageFile: "image16.png", alt: "berkelium" },
  beryllium: { imageFile: "image17.png", alt: "beryllium" },
  bismuth: { imageFile: "image18.png", alt: "bismuth" },
  bohrium: { imageFile: "image19.png", alt: "bohrium" },
  boron: { imageFile: "image20.png", alt: "boron" },
  "broken-glass": { imageFile: "image21.png", alt: "broken-glass" },
  bromine: { imageFile: "image22.png", alt: "bromine" },
  cadmium: { imageFile: "image23.png", alt: "cadmium" },
  calcium: { imageFile: "image24.png", alt: "calcium" },
  californium: { imageFile: "image25.png", alt: "californium" },
  carbon: { imageFile: "image26.png", alt: "carbon" },
  "card-stock": { imageFile: "image27.png", alt: "card-stock" },
  cardboard: { imageFile: "image28.png", alt: "cardboard" },
  "cardboard-box": { imageFile: "image29.png", alt: "cardboard-box" },
  "ceramic-tile": { imageFile: "image30.png", alt: "ceramic-tile" },
  ceramics: { imageFile: "image31.png", alt: "ceramics" },
  cerium: { imageFile: "image32.png", alt: "cerium" },
  cesium: { imageFile: "image33.png", alt: "cesium" },
  chlorine: { imageFile: "image34.png", alt: "chlorine" },
  chromium: { imageFile: "image35.png", alt: "chromium" },
  "clamshell-packaging": {
    imageFile: "image36.png",
    alt: "clamshell-packaging",
  },
  "clear-glass-bottle": { imageFile: "image37.png", alt: "clear-glass-bottle" },
  "clothes-hanger": { imageFile: "image38.png", alt: "clothes-hanger" },
  cobalt: { imageFile: "image39.png", alt: "cobalt" },
  "coffee-grounds": { imageFile: "image40.png", alt: "coffee-grounds" },
  ...
  "concrete-rubble": { imageFile: "image43.png", alt: "concrete-rubble" },
  "contact-lens": { imageFile: "image44.png", alt: "contact-lens" },
  copernicium: { imageFile: "image45.png", alt: "copernicium" },
  copper: { imageFile: "image46.png", alt: "copper" },
  "copper-wire": { imageFile: "image47.png", alt: "copper-wire" },
  cork: { imageFile: "image48.png", alt: "cork" },
  "cotton-t-shirt": { imageFile: "image49.png", alt: "cotton-t-shirt" },
  "crystal-glass": { imageFile: "image50.png", alt: "crystal-glass" },
  ...
  francium: { imageFile: "image72.png", alt: "francium" },
  gadolinium: { imageFile: "image73.png", alt: "gadolinium" },
  gallium: { imageFile: "image74.png", alt: "gallium" },
  germanium: { imageFile: "image75.png", alt: "germanium" },
  glass: { imageFile: "image76.png", alt: "glass" },
  "glass-jar": { imageFile: "image77.png", alt: "glass-jar" },
  gold: { imageFile: "image78.png", alt: "gold" },
  granite: { imageFile: "image79.png", alt: "granite" },
  "grass/grass-clippings": {
    imageFile: "image80.png",
    alt: "grass/grass-clippings",
  },
  hafnium: { imageFile: "image81.png", alt: "hafnium" },
  hassium: { imageFile: "image82.png", alt: "hassium" },
  "hdpe-plastic-container": {
    imageFile: "image83.png",
    alt: "hdpe-plastic-container",
  },
  helium: { imageFile: "image84.png", alt: "helium" },
  holmium: { imageFile: "image85.png", alt: "holmium" },
  hydrogels: { imageFile: "image86.png", alt: "hydrogels" },
  hydrogen: { imageFile: "image87.png", alt: "hydrogen" },
  "incandescent-bulb": { imageFile: "image88.png", alt: "incandescent-bulb" },
  indium: { imageFile: "image89.png", alt: "indium" },
  iodine: { imageFile: "image90.png", alt: "iodine" },
  iridium: { imageFile: "image91.png", alt: "iridium" },
  iron: { imageFile: "image92.png", alt: "iron" },
  krypton: { imageFile: "image93.png", alt: "krypton" },
  "laminate-tubes": { imageFile: "image94.png", alt: "laminate-tubes" },
  lanthanum: { imageFile: "image95.png", alt: "lanthanum" },
  "laptop-computer": { imageFile: "image96.png", alt: "laptop-computer" },
  lawrencium: { imageFile: "image97.png", alt: "lawrencium" },
  "ldpe-plastic-bag": { imageFile: "image98.png", alt: "ldpe-plastic-bag" },
  lead: { imageFile: "image99.png", alt: "lead" },
  "lead-crystal-glass": {
    imageFile: "image100.png",
    alt: "lead-crystal-glass",
  },
  "leather-goods": { imageFile: "image101.png", alt: "leather-goods" },
  "led-light-bulb": { imageFile: "image102.png", alt: "led-light-bulb" },
  lithium: { imageFile: "image103.png", alt: "lithium" },
  "lithium-ion-battery": {
    imageFile: "image104.png",
    alt: "lithium-ion-battery",
  },
  livermorium: { imageFile: "image105.png", alt: "livermorium" },
  lutetium: { imageFile: "image106.png", alt: "lutetium" },
  magazine: { imageFile: "image107.png", alt: "magazine" },
  magnesium: { imageFile: "image108.png", alt: "magnesium" },
  "makeup-brush": { imageFile: "image109.png", alt: "makeup-brush" },
  manganese: { imageFile: "image110.png", alt: "manganese" },
  meitnerium: { imageFile: "image111.png", alt: "meitnerium" },
  mendelevium: { imageFile: "image112.png", alt: "mendelevium" },
  mercury: { imageFile: "image113.png", alt: "mercury" },
  "mixed-fabric-scraps": {
    imageFile: "image114.png",
  ...
  "mixed-scrap-metal": { imageFile: "image116.png", alt: "mixed-scrap-metal" },
  molybdenum: { imageFile: "image117.png", alt: "molybdenum" },
  moscovium: { imageFile: "image118.png", alt: "moscovium" },
  neodymium: { imageFile: "image119.png", alt: "neodymium" },
  neon: { imageFile: "image120.png", alt: "neon" },
  neptunium: { imageFile: "image121.png", alt: "neptunium" },
  newspaper: { imageFile: "image122.png", alt: "newspaper" },
  nickel: { imageFile: "image123.png", alt: "nickel" },
  nihonium: { imageFile: "image124.png", alt: "nihonium" },
  niobium: { imageFile: "image125.png", alt: "niobium" },
  nitrogen: { imageFile: "image126.png", alt: "nitrogen" },
  nobelium: { imageFile: "image127.png", alt: "nobelium" },
  "nylon-fabric": { imageFile: "image128.png", alt: "nylon-fabric" },
  obsidian: { imageFile: "image129.png", alt: "obsidian" },
  "office-paper": { imageFile: "image130.png", alt: "office-paper" },
  oganesson: { imageFile: "image131.png", alt: "oganesson" },
  osmium: { imageFile: "image132.png", alt: "osmium" },
  oxygen: { imageFile: "image133.png", alt: "oxygen" },
  palladium: { imageFile: "image134.png", alt: "palladium" },
  paper: { imageFile: "image135.png", alt: "paper" },
