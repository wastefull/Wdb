...
const availability = getParameterAvailability(
  exampleMaterial,
  allParameterKeys
);
...
// ============================================================
console.log("\n=== Example 3: Filter Parameters With Sources ===");
const withSources = filterParametersWithSources(
  exampleMaterial,
  allParameterKeys
);
...
// ============================================================
console.log("\n=== Example 4: Filter Parameters Without Sources ===");
const withoutSources = filterParametersWithoutSources(
  exampleMaterial,
  allParameterKeys
);
...
// ============================================================
console.log("\n=== Example 5: Build Global Cache ===");
const globalCache = buildParameterSourceCache(
  exampleMaterials,
  allParameterKeys
);
...
const hasValue = (param: string) =>
  (exampleMaterial as any)[param] !== undefined &&
  (exampleMaterial as any)[param] !== null;
