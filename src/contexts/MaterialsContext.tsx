  ...
  const loadFromLocalStorage = () => {
    ...
    if (stored) {
      try {
        ...
        syncLogger.info(`Loaded ${materialsWithArticles.length} materials from localStorage`);
      } catch (e) {
    ...
    const loadMaterials = async () => {
      ...
      try {
        ...
        if (supabaseMaterials.length > 0) {
          ...
          syncLogger.info(`Loaded ${materialsWithArticles.length} materials from Supabase`);
        } else {
