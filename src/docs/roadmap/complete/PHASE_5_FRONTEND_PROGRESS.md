    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => handleParameterChange('B_value', parseFloat(e.target.value) || 0)}
          className="text-[12px]"
        />
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => handleParameterChange('N_value', parseFloat(e.target.value) || 0)}
          className="text-[12px]"
        />
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => handleParameterChange('T_value', parseFloat(e.target.value) || 0)}
          className="text-[12px]"
        />
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e) => handleParameterChange('H_value', parseFloat(e.target.value) || 0)}
          className="text-[12px]"
        />
      ...
      <div className="grid grid-cols-3 gap-3">
        <div>
          ...
          <Input
            ...
            onChange={(e) => handleParameterChange('CC_practical_mean', parseFloat(e.target.value) || 0)}
            className="text-[12px]"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => handleParameterChange('CC_practical_CI95', {
      ...
      <div className="grid grid-cols-3 gap-3">
        <div>
          ...
          <Input
            ...
            onChange={(e) => handleParameterChange('CC_theoretical_mean', parseFloat(e.target.value) || 0)}
            className="text-[12px]"
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => handleParameterChange('CC_theoretical_CI95', {
