...
*A foundation document for future product, data, and design changes.*
...
*Objectives:* Median time per MIU < 3 minutes after first day; inter-curator agreement κ ≥ 0.7 on categorical fields; median numeric delta ≤ 5%.
...
*Validation:* MIU requires parameter, raw value + units, locator, snippet, transform version; “derived” requires a formula. Aggregation requires ≥3 MIUs or applies a “low confidence” label.
