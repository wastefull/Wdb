...
export function TakedownRequestForm({
  onSubmitSuccess,
  onBack,
}: TakedownRequestFormProps) {
  const { navigateToTakedownStatus, navigateToMaterials } =
  ...
  const validateForm = () => {
    ...
    if (!formData.relationship.trim())
      newErrors.relationship = "Relationship to copyright is required";
    if (!formData.wastedbURL.trim())
      newErrors.wastedbURL = "WasteDB URL is required";
    if (!formData.contentDescription.trim())
      newErrors.contentDescription = "Content description is required";

    // Legal statements
    if (!formData.goodFaithBelief)
      newErrors.goodFaithBelief = "This statement is required";
    if (!formData.accuracyStatement)
      newErrors.accuracyStatement = "This statement is required";
    if (!formData.misrepresentationWarning)
      newErrors.misrepresentationWarning = "You must acknowledge this warning";

    // Signature
    if (!formData.signature.trim())
      newErrors.signature = "Electronic signature is required";
    if (
      formData.signature.toLowerCase() !==
      ...
      setErrors({
        submit:
          error instanceof Error
            ? error.message
            : "Failed to submit request. Please try again or email compliance@wastefull.org",
      });
    } finally {
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  We've received your copyright takedown request
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                <div className="space-y-2">
                  ...
                  <p>
                    We will respond within <strong>72 hours</strong> with an
                    initial review.
                  </p>
                </div>
              </AlertDescription>
            ...
            <div className="bg-muted p-4 rounded-lg space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm">
                <li>
                  Within 24 hours: Confirmation email sent (check spam folder)
                </li>
                <li>Within 72 hours: Legal team reviews your request</li>
                <li>
                  Within 7 days: Decision communicated and resolution
                  implemented
                </li>
              </ol>
            </div>
    ...
    >
      <Alert>
        ...
        <AlertDescription>
          ...
          <a href="/legal/MIU_LICENSING_POLICY.md" className="underline">
            MIU Licensing Policy
          </a>{" "}
          and{" "}
          <a href="/legal/TAKEDOWN_PROCESS.md" className="underline">
            Takedown Process
          </a>{" "}
          to understand what content is subject to removal. Consider contacting
          us informally at info@wastefull.org for faster resolution.
        </AlertDescription>
      </Alert>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("copyrightRegistration", e.target.value)
                  }
            ...
            <div className="space-y-2">
              <Label htmlFor="relationship">
                Your Relationship to Copyright *
              </Label>
              <Input
                id="relationship"
              ...
              <p className="text-sm text-muted-foreground">
                Example: "I am the first author" or "I am legal counsel for
                Publisher X"
              </p>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              These statements are required under DMCA and must be made in good
              faith
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleChange("goodFaithBelief", checked as boolean)
                }
                className={errors.goodFaithBelief ? "border-red-500" : ""}
              />
              <div className="space-y-1">
                <Label htmlFor="goodFaithBelief" className="cursor-pointer">
                  I have a good faith belief that use of the material is not
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleChange("accuracyStatement", checked as boolean)
                }
                className={errors.accuracyStatement ? "border-red-500" : ""}
              />
              <div className="space-y-1">
                <Label htmlFor="accuracyStatement" className="cursor-pointer">
                  The information in this notification is accurate, and I am
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleChange("misrepresentationWarning", checked as boolean)
                }
                className={
                  errors.misrepresentationWarning ? "border-red-500" : ""
                }
              />
              <div className="space-y-1">
                <Label
                  htmlFor="misrepresentationWarning"
                  className="cursor-pointer"
                >
                  I understand that under 17 U.S.C. § 512(f), I may be liable
                  for damages if I knowingly misrepresent that material is
                  infringing. *
                </Label>
