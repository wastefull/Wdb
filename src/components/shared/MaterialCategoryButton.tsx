...
export function MaterialCategoryButton({
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: `var(${categoryToCssVar(category)})`,
        color: `var(${categoryToContrastCssVar(category)})`,
      }}
      className="tag text-fine-outline cursor-pointer w-fit whitespace-nowrap"
