...
const licenses: License[] = [
  ...
  },
  {
    ...
    description:
      "Unstyled, accessible components for building design systems (used by shadcn/ui)",
  },
  {
    name: "Lucide React",
...
export function LicensesView({ onBack }: { onBack: () => void }) {
  return (
    ...
    >
      ...
      {/* Footer Note */}
      <div className="mt-8 p-4 bg-[#e5e4dc] dark:bg-[#1a1917] border-[1.5px] border-[#211f1c]/20 dark:border-white/20 rounded-(--retro-rounding)">
        <p className="text-[12px] text-black/70 dark:text-white/70">
          ...
          please refer to the individual project repositories.
        </p>
      </div>
    </PageTemplate>
  );
