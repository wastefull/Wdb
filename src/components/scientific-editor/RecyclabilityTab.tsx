...
export function RecyclabilityTab({
  formData,
  onParameterChange,
}: DimensionTabProps) {
  const handleRecalculateFromParams = () => {
    ...
    const practicalMargin = CR_practical * 0.1;
    const theoreticalMargin = CR_theoretical * 0.1;
    ...
    <div className="space-y-4">
      ...
      <Card className="panel">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                onParameterChange("Y_value", parseFloat(e.target.value) || 0)
              }
              className="text-[12px]"
            />
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                onParameterChange("D_value", parseFloat(e.target.value) || 0)
              }
              className="text-[12px]"
            />
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                onParameterChange("C_value", parseFloat(e.target.value) || 0)
              }
              className="text-[12px]"
            />
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                onParameterChange("E_value", parseFloat(e.target.value) || 0)
              }
              className="text-[12px]"
            />
        ...
        <Button
          ...
          className="mt-4 w-full bg-waste-reuse hover:bg-[#a8b8bb] text-black"
        >
