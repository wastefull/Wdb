...
export function AnimatedWasteChart({
  chartData,
  onCategoryClick,
}: AnimatedWasteChartProps) {
                ...
                <defs>
                  ...
                  <motion.path
                    ...
                    animate={{
                      d: hasAnimated
                        ? [
                            `M ${pathStart} ${centerY} Q ${centerX} ${
                              centerY - initialRadius + 60
                            } ${pathEnd} ${centerY}`, // Gentle curve
                            `M ${pathStart} ${centerY} Q ${centerX} ${
                              centerY - finalRadius + mobileCurveOffset
                            } ${pathEnd} ${centerY}`, // Very tight curve
                          ]
            ...
            <ResponsiveContainer width="100%" height={280}>
              ...
              >
                <defs>
                  ...
                  >
                    <rect
                      width="3"
                      height="3"
                      fill={settings.darkMode ? "#1a1917" : "#fff"}
                    />
                    <image
                      href="https://www.transparenttextures.com/patterns/3px-tile.png"
                      x="0"
                      y="0"
                      width="3"
                      height="3"
                  ...
                  >
                    ...
                    />
                    <feFlood
                      floodColor="rgba(100, 100, 100, 0.8)"
                      result="floodColor"
                    />
                    <feComposite
                      in="floodColor"
                  ...
                  >
                    ...
                    />
                    <feFlood
                      floodColor="rgba(220, 220, 220, 0.5)"
                      result="floodColor"
                    />
                    <feComposite
                      in="floodColor"
                ...
                <RadialBar
                  ...
                  cornerRadius={10}
                  stroke={
                    settings.darkMode ? "rgba(255,255,255,0.3)" : "#211f1c"
                  }
                  strokeWidth={1.5}
                  strokeOpacity={0.6}
