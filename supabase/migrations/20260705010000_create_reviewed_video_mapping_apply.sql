-- Stage 7: promote explicitly reviewed video material identifiers into
-- pending-review primary-subject content mappings.
  ...
  LOOP
    ...
    IF p_apply THEN
      ...
      INSERT INTO public.content_entities (
        ...
        v_candidate.video_entity_id,
        v_material_entity_id,
        'primary_subject',
        'pending_review',
        p_admin_id
      )
